...
<div markdown="0" id="carousel" class="carousel slide" data-ride="carousel" data-interval="4000" data-pause="hover">
    ...
    <div class="carousel-inner" markdown="0">
        <div class="item active">
            <img src="{{ site.url }}{{ site.baseurl }}/images/slider7001400/scilifelab_building.jpg"
                 alt="SciLifeLab building" />
        </div>

        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/slider7001400/SciLifeLab_Logo.jpg"
                 alt="SciLifeLab logo" />
        </div>

        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/images/slider7001400/Karolinska_Institutet_Science_Park,_2019.jpg"
                 alt="Karolinska Institutet Science Park" />
        </div>
    </div>
